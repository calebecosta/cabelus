...
routes.post('/cliente', ClienteController.store); // Cadastro de Usuario
routes.get('/cliente/:id', ClienteController.show); // Listar um usuario

routes.get('/colaborador/:id', ColaboradorController.show); // Listar um colaborador
...
routes.get('/cliente/', ClienteController.index); // listar todos clientes
